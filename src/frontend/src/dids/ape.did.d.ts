...
export default interface _SERVICE {
  ...
  http_request_streaming_callback: (arg_0: HttpStreamingCallbackToken) => Promise<HttpStreamingCallbackResponse>;
  ...
  reserve: (arg_0: bigint, arg_1: bigint, arg_2: AccountIdentifier__1, arg_3: SubAccount__1) => Promise<Result_5>;
