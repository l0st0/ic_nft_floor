export const idlFactory = ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    addAsset: IDL.Func([IDL.Text, IDL.Text, IDL.Text], [IDL.Text], []),
    ...
    getAssets: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, Asset))], ['query']),
    ...
    http_request_streaming_callback: IDL.Func([HttpStreamingCallbackToken], [HttpStreamingCallbackResponse], ['query']),
    ...
    salesStats: IDL.Func(
      ...
      [IDL.Nat, IDL.Opt(Time), IDL.Tuple(IDL.Text, IDL.Nat64, IDL.Nat64, IDL.Bool), IDL.Bool],
      ['query']
    ),
    ...
    streamAsset: IDL.Func([IDL.Text, IDL.Vec(IDL.Nat8), IDL.Bool], [IDL.Bool], []),
